<x-app-layout>
    <x-slot name="title"> | Create Offer</x-slot>
    ...
    <x-slot name="maincontent">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4 text-center">Create Offer</h4>
            <div class="row mb-4">
                <!-- Browser Default -->
                <div class="col-md mb-4 mb-md-0">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('offers.store') }}" method="post" class="browser-default-validation" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3 image-preview">
                                    ...
                                    <img src="{{ asset(\App\Models\Offer::PLACEHOLDER_IMAGE_PATH) }}" alt="" width="300" height="300" class="mr-3">
